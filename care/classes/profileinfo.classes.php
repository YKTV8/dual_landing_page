...
class ProfileInfo extends Dbh {
    ...
    protected function getProfileInfo($userId) {
        ...
        $profileData = $stmt->fetchAll(PDO::FETCH_ASSCO);
    ...
    protected function setProfileInfo($profileAbout, $profileTitle, $profileText, $userId) {
        $stmt = $this->connect()->prepare('INSERT INTO profiles(profiles_about, profiles_introtitle, profile_introtext, users_id) VALUES (?,?,?,?);');
